...
class FilterInterpolationLayer(Function):
    ...
    def forward(ctx, input1, input2, input3):
        # input4代表deconv field
        assert(input1.is_contiguous())
        assert(input2.is_contiguous())
        assert(input3.is_contiguous())
        # assert(input4.is_contiguous())
        ...
        if input1.is_cuda :
            ...
            my_lib.FilterInterpolationLayer_gpu_forward_ori(input1, input2, input3, output)
            # my_lib.FilterInterpolationLayer_gpu_forward(input1, input2, input3, input4, output)
            # my_lib.FilterInterpolationLayer_gpu_forward_deforconv(input1, input2, input3, input4, output)
            # my_lib.FilterInterpolationLayer_gpu_forward_nofilterwithdeforconv(input1, input2, input3, output) # input1:ref  input2: flow  input3: defor conv
    ...
    def backward(ctx, gradoutput):
        ...
        # gradinput4 = torch.cuda.FloatTensor().resize_(input4.size()).zero_()
        if input1.is_cuda:
            # print("CUDA backward")
            ...
            err = my_lib.FilterInterpolationLayer_gpu_backward_ori(input1, input2, input3, gradoutput, gradinput1, gradinput2, gradinput3)
            # err = my_lib.FilterInterpolationLayer_gpu_backward(input1, input2, input3, input4, gradoutput, gradinput1, gradinput2, gradinput3, gradinput4)
            # err = my_lib.FilterInterpolationLayer_gpu_backward_deforconv(input1, input2, input3, input4, gradoutput, gradinput1, gradinput2, gradinput3, gradinput4)
            # err = my_lib.FilterInterpolationLayer_gpu_backward_nofilterwithdeforconv(input1, input2, input3, gradoutput, gradinput1, gradinput2, gradinput3)
            if err != 0 :
                print(err)
        ...
        # return gradinput1, gradinput2, gradinput3, gradinput4
