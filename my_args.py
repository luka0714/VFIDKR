...
parser.add_argument('--datasetPath',default='./vimeo_septuplet/',help = 'the path of selected datasets')
...
parser.add_argument('--batch_size', '-b',type = int ,default=3, help = 'batch size (default:1)' )
...
parser.add_argument('--patience', type=int, default=3, help = 'the patience of reduce on plateou')
parser.add_argument('--factor', type = float, default=0.2, help = 'the factor of reduce on plateou')
#
# parser.add_argument('--pretrained', dest='SAVED_MODEL', default="./checkpoints/epoch7/epoch7.pth", help ='path to the pretrained model weights')
